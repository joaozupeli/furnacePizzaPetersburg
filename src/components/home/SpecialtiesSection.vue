      ...
      <div class="specialties__head">
        <div>
          ...
          <h2 ref="title" class="specialties__title display">
            What comes out of <em>the oven</em>
          </h2>
        </div>
        <p data-anim class="lead specialties__lead">
          Neapolitan crust, wood-fired heat, and rotating specials across Petersburg, Richmond, and the 757.
        </p>
      </div>
        ...
        >
          ...
          <div :id="`spec-${item.id}`" class="row__panel">
            <div class="row__panelInner">
              ...
              <a class="link" :href="`mailto:${clinic.email}?subject=Furnace%20Pizza%20—%20${encodeURIComponent(item.title)}`">
