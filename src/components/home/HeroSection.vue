...
const mailHref = `mailto:${clinic.email}?subject=${encodeURIComponent('Furnace Pizza — hello from your demo site')}`
const facts = [
  { label: 'Pop-ups', value: clinic.hours[0].time },
  { label: 'Good to know', value: `${clinic.insurance.length} highlights` },
  { label: 'Circuit', value: '804 & 757' },
]
